  ...
  return (
    <div>
      ...
      <div className='container'>
        ...
        )) : <div className="mx-auto mt-4 item-center"><img src="https://cdn.pixabay.com/animation/2023/10/08/03/19/03-19-26-213_512.gif" width={200} height={200} className= {` ${ isLoading ? ''  : 'hidden'}`} alt="" />
