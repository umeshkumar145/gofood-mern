  ...
  return (
    <div>
      ...
      <div className='container'>
        ...
        )) : <div><img src="https://cdn.pixabay.com/animation/2023/10/08/03/19/03-19-26-213_512.gif" width={300} className= {` ${ isLoading ? ''  : 'hidden'} ` } alt="" Please wait until we are fetching categories.../>
